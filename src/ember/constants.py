"""Lorax / BLE constants forked from Fr0st3h/PuffcoBLE."""
...
OPERATING_STATE_LABELS = {
    OperatingState.INIT_MEMORY: "Starting",
    OperatingState.INIT_VERSION_DISP: "Starting",
    OperatingState.INIT_BATTERY_DISP: "Starting",
    OperatingState.MASTER_OFF: "Off",
    OperatingState.SLEEP: "Sleep",
    OperatingState.IDLE: "Idle",
    OperatingState.TEMP_SELECT: "Selecting",
    OperatingState.HEAT_CYCLE_PREHEAT: "Preheating",
    OperatingState.HEAT_CYCLE_ACTIVE: "Ready",
    OperatingState.HEAT_CYCLE_FADE: "Cooling",
    OperatingState.VERSION_DISP: "Version",
    OperatingState.BATTERY_DISP: "Battery",
    OperatingState.FACTORY_TEST: "Factory test",
    OperatingState.BLE_BONDING: "Pairing",
}

CHARGE_STATE_LABELS = {
    BatteryChargeState.BULK: "Charging",
    BatteryChargeState.TOPUP: "Topping up",
    BatteryChargeState.FULL: "Full",
    BatteryChargeState.TEMP_STOP: "Charge paused",
